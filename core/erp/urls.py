...
from core.erp.views.diseno.views import *
...
urlpatterns = [   
    ...
    #diseño
    path('diseno/list/', DisenoListView.as_view(), name='diseno_list'),
    path('diseno/add/', DisenoCreateView.as_view(), name='diseno_create'),
    path('diseno/update/<str:pk>/', DisenoUpdateView.as_view(), name='diseno_update'),
    path('diseno/delete/<str:pk>/', DisenoDeleteView.as_view(), name='diseno_delete'),
